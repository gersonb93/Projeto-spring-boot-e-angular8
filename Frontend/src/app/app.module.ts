...
import { HomeComponent } from './views/home/home.component'; /*Requisi��es Ajax*/
...
import { FooterComponent } from './componente/template/footer/footer.component';
import { NavComponent } from './componente/template/nav/nav.component';
import { HeaderComponent } from './componente/template/header/header.component';
...
export const appRouters: Routes = [
  ...
  { path: 'upload', component: UploadFileComponent, canActivate: [GuardiaoGuard] }
